...
func dataSourceRedisManagedDatabase() *pluginsdk.Resource {
	...
	return &pluginsdk.Resource{
		Read: dataSourceRedisManagedDatabaseRead,
...
func dataSourceRedisManagedDatabaseRead(d *pluginsdk.ResourceData, meta interface{}) error {
