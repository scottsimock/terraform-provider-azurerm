...
// RedisManagedClusterSkuName - validates if passed input string contains a valid Redis Enterprise Cluster Sku
func RedisManagedClusterSkuName(v interface{}, k string) (warnings []string, errors []error) {
	validSku := false
	validCapacity := false
