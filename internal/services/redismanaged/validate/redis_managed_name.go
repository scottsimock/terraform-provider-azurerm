...
// RedisManagedName - validates that the passed interface contains a valid Redis Enterprise Name
func RedisManagedName(i interface{}, k string) (warnings []string, errors []error) {
	v, ok := i.(string)
	if !ok {
